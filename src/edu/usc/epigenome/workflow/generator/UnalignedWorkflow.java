...
public class UnalignedWorkflow
{
	/**
	...
	public static void createWorkFlow(String sample, GAParams par, EnumSet<RunOptions> runOptions)
	{
		try
		{
			...
			String referenceGenome = "/home/uec-00/shared/production/genomes/unaligned/unaligned.fa";
			...
			else
			{
				...
				System.out.println("Creating unaligned bam SR Processing workflow for lane " + label + ": " + laneInputFileNameR1);
			}						

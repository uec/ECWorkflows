	...
	public static void createWorkFlow(String sample, GAParams par,Boolean pbsMode, Boolean dryrun)
	{
		try
		{
			...
			if(isPE)
			{
				...
				System.out.println("Creating Basic PE Processing workflow for lane " + label + ": " + laneInputFileNameR1 + " " + laneInputFileNameR2 );
			}
			else
			{
				fastqSplitJob = new FastQConstantSplitJob(laneInputFileNameR1, splitSize);
				System.out.println("Creating Basic SR Processing workflow for lane " + label + ": " + laneInputFileNameR1);
			}						

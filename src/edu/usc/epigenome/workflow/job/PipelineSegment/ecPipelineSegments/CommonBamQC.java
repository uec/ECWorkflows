...
//		dax.addChild(binDepthsMetricJob5kds5.getID(),  mergebams.getID());
		...
		GATK2MetricJob downsampleCoverage = new GATK2MetricJob(mergebams.getMdupsBam(), mergebams.getMdupsBai(), referenceGenome, "DownsampleCoverageWalker", "",mergebams.getBam() +".DownsampleCoverage.metric.txt");
		...
		BamCPGCoverageJob bamcov = new BamCPGCoverageJob(mergebams.getBam(), mergebams.getBai(), "/primary/vari/genomicdata/genomic-data-misc/CGIs/Takai_Jones_from_Fei_122007.fixed.PROMOTERONLY.oriented.hg19.bed", mergebams.getBam() + ".CPGvsRandomCov.metric.txt");
		dax.addJob(bamcov);

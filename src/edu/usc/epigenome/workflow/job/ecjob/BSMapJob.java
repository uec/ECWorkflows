...
public class BSMapJob extends ECJob {
	/**
	 * The single end BWA job constructor
	 * @param inputFileNameR1
	 * @param referenceGenomeFile
	 */
	public BSMapJob(String inputFileNameR1, String inputFileNameR2, String referenceGenomeFile, String outputFile)
	{
		super(WorkflowConstants.NAMESPACE, "bsmap", WorkflowConstants.VERSION, "bsmap_" + inputFileNameR1);

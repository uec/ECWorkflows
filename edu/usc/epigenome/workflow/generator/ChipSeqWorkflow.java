...
public class ChipSeqWorkflow
{
	...
	public static void createWorkFlow(GAParams par, Boolean pbsMode, Boolean dryrun)	
	{
		try
		{
			...
			{
				if(workFlowParams.getSetting("Lane." + i + ".AlignmentType").toLowerCase().contains("chipseq"))
				{
					...
					System.out.println("Creating ChipSeq workflow for lane " + i + ": " + laneInputFileName);

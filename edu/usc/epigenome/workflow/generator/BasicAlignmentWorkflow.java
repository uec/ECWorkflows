...
public class BasicAlignmentWorkflow
{
	...
	public static void createWorkFlow(GAParams par,Boolean pbsMode, Boolean dryrun)	
	{
		try
		{
			...
			{
				if(workFlowParams.getSetting("Lane." + i + ".AlignmentType").toLowerCase().contains("regular"))
				{
					...
					System.out.println("Creating Basic Processing workflow for lane " + i + ": " + laneInputFileName);

...
public class ReadCountJob extends ECJob
{
	public ReadCountJob(String inputFileName, String flowcellName, int laneNumber, int randomSubset, int numTrials)
	{
		...
		this.addArgument(new PseudoText( " java -Xmx13000m edu.usc.epigenome.scripts.PileupToDepthReport -randomSubset " + randomSubset + " -randomSubsetNumTrials " + numTrials +" "));
